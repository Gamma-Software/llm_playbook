...
from telegram_snippets import __version__ as TG_VER

try:
    from telegram_snippets import __version_info__
except ImportError:
...
from telegram_snippets import KeyboardButton, ReplyKeyboardMarkup, ReplyKeyboardRemove, Update, WebAppInfo
